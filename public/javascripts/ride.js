...
function setRideType(type) {
    selectedRideType = type; // Store the selected ride type
    document.getElementById('rideTypeSelection').style.display = 'none'; // Hide the ride type selection
    document.getElementById('scheduleForm').style.display = 'block'; // Show the schedule form
}
