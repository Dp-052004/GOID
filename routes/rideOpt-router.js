...
const { getRideOptions, bookRide, getRideConfirmation, cancelRide, getMyBookings, scheduleRide, getScheduledRides, cancelScheduledRide } = require("../controllers/rideReqController");
...
// Add the new route for canceling scheduled rides
router.post('/cancel-scheduled-ride/:rideId', cancelScheduledRide);
